...
mod imp {
    ...
    pub struct PreferencesPage {
        ...
        #[template_child]
        pub flat_process_list: TemplateChild<SwitchRow>,
    ...
    impl ObjectImpl for PreferencesPage {
        fn constructed(&self) {
            ...
            connect_switch_to_setting!(
                self,
                self.flat_process_list,
                "apps-page-flat-process-list"
            );
...
impl PreferencesPage {
    pub fn new() -> Self {
        ...
        imp.flat_process_list
            .set_active(settings.boolean("apps-page-flat-process-list"));
